...
const FooterSection: React.FC = () => {
    return (
        <div className='bg-maroon text-white flex justify-center items-start pt-8'>
            <div className='flex-1 'style={{ paddingLeft: '100px' }}>
                <p className='text-xl font-bold mb-6'>ABOUT US</p>
                <div className='mb-4' style={{fontSize: '18px'}}><p>This is a short description about the Temples.</p> 
                    <p>This will be 3 to 4 lines.</p></div>
                <div>
